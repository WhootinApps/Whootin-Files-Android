...
import com.whootin.whootinviewpager.AniViewPager.TransitionEffect;

public class Animation_Activity extends Activity {

	private AniViewPager mJazzy;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.lib_animation);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		String[] effects = this.getResources().getStringArray(R.array.animation_effects);
	...
	private void setupJazziness(TransitionEffect effect) {
		mJazzy = (AniViewPager) findViewById(R.id.jazzy_pager);
	...
	private class MainAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			TextView text = new TextView(Animation_Activity.this);
